    ...
    return {
        Engines: {
            ...
            duckduckgo: function () {
                ...
                // patterns that the engine can resolve
                var capabilities = [
                    "Pregunte cómo es algo como '¿Qué es el CRM?'",
                    "Preguntar dónde es algo como '¿Para que sirve el CRM?'",
                    "Pregunte Preguntar dónde es algo como '¿Como agrego una venta?'",
                    "Preguntar dónde es algo como '¿Como agrego un Cliente?'",
                    "Pregunte cómo es algo como '¿Cuáles son las funcionalidades de seguimiento de ventas?'",
                    "Diga el nombre de una película/persona/ubicación como 'CRM' para obtener información sobre esa entidad",
                    "Di algo como 'Uso del CRM' para obtener información sobre esa frase",
                ];
                    ...
                    react: function (query) {
                        $.ajax({
                            ...
                            if (content == '' && data.RelatedTopics.length > 0) {
                                ...
                                content = '<p>He encontrado multiples respuestas para tí:</p>';
